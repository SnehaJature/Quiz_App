...
public class QuizActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(layout.activity_quiz2);

        textViewQuestion = findViewById(id.text_view_question);
        textViewScore = findViewById(id.text_view_score);
        textViewQuestionCount = findViewById(id.text_view_question_count);
        textViewCategory = findViewById(id.text_view_category);
        textViewDifficulty = findViewById(id.text_view_difficulty);
        textViewCountDown = findViewById(id.text_view_countdown);
        rbGroup = findViewById(id.radio_group);
        rb1 = findViewById(id.radio_button1);
        rb2 = findViewById(id.radio_button2);
        rb3 = findViewById(id.radio_button3);
        buttonConfirmNext = findViewById(id.button_confirm_next);
